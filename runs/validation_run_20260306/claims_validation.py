# This script uses a local Ollama model to validate the mappings between subclaims and superclaims.
# Before running:
#   1. Install Ollama: https://ollama.com/download
#   2. Pull a model (e.g. ollama pull llama3) and update MODEL below to match
